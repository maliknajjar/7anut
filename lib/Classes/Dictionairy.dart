class Dictionairy {
  static Map<String, Map<String, String>> words = {
    ...
    "category is empty": {
      "en": "This category is empty on this current location",
      "fr": "Cette catégorie est vide à cet emplacement actuel",
      "ar": "هذه الفئة فارغة في هذا الموقع الحالي"
    },
  };
}